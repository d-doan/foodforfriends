...
public class Initializer implements CommandLineRunner {
        ...
        public void run(String... strings) {
                ...
                // ----------------------REVIEW----------------------
                Review review1 = Review.builder().restaurantName("restaurant1").username("nggv2").datePosted(Utility.getTime()).rating(3.0).cost(2)
                                .description("mid")
                                .build();
                Review review2 = Review.builder().restaurantName("restaurant1").username("waffle").datePosted(Utility.getTime()).rating(4.0).cost(5)
                                ...
                                .build();
                Review review3 = Review.builder().restaurantName("restaurant1").username("Matthew").datePosted("2023-08-29 16:34:25").rating(2.0).cost(2)
